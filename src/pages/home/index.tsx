...
import MovieRecommendCard from "../../components/movie-card";
...
const Home = () => {
  ...
  const recommendeList = movies.filter((item)=>item.isTrending!==true);
         ...
         {search ===""?(
          <Box width="100%">
               ...
               <Box width="100%">
                ...
                <MovieList recommendeList={recommendeList}/>
                </Box>
